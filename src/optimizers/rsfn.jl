...
- `LFASolver` instance.
"""
function LFASolver(dim::Int; type::Type{<:AbstractVector{R}}=Vector{Float64}, depth::Int=dim ≤ 10 ? dim : ceil(Int, log2(dim)), adapt::Bool=true, min_depth::Int=dim ≤ 10 ? dim : 2, max_depth::Int=dim, α₊::R=1.5, α₋::R=1.5, levels::Int=1) where {R<:AbstractFloat}
